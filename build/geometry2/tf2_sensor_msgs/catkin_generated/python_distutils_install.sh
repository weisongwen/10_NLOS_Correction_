...
echo_and_run cd "/home/wenws/10_NLOS_Correction_/src/geometry2/tf2_sensor_msgs"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/wenws/10_NLOS_Correction_/build/geometry2/tf2_sensor_msgs" \
    install \
    $DESTDIR_ARG \
