...
"""autogenerated by genpy from cv_tracker_msgs/image_obj_tracked.msg. Do not edit."""
import sys
...
class image_obj_tracked(genpy.Message):
  _md5sum = "6f3751f77b67bc47fba29cbdd3ea3d56"
  _type = "cv_tracker_msgs/image_obj_tracked"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','uint8','int32[]','cv_tracker_msgs/image_rect_ranged[]','int32[]','int32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(image_obj_tracked, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_B.pack(self.total_num))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.total_num,) = _struct_B.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%si'%length
      ...
      for i in range(0, length):
        val1 = cv_tracker_msgs.msg.image_rect_ranged()
        _v2 = val1.rect
        _x = _v2
        start = end
        end += 20
