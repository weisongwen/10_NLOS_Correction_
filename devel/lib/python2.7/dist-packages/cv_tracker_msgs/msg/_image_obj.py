...
"""autogenerated by genpy from cv_tracker_msgs/image_obj.msg. Do not edit."""
import sys
...
class image_obj(genpy.Message):
  _md5sum = "07ef08924af0932bcdf48f6ca49c8c23"
  _type = "cv_tracker_msgs/image_obj"
...
"""
  ...
  _slot_types = ['std_msgs/Header','string','cv_tracker_msgs/image_rect[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(image_obj, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cv_tracker_msgs.msg.image_rect()
        _x = val1
        start = end
        end += 20
