...
"""autogenerated by genpy from lidar_tracker/CloudCluster.msg. Do not edit."""
import sys
...
class CloudCluster(genpy.Message):
  _md5sum = "d79f3de19e797fd29b6fdf347509c864"
  _type = "lidar_tracker/CloudCluster"
...
float32 y
float32 z"""
  __slots__ = ['header','id','label','score','cloud','min_point','max_point','avg_point','centroid_point','estimated_angle','dimensions','eigen_values','eigen_vectors','fpfh_descriptor','bounding_box','convex_hull']
  _slot_types = ['std_msgs/Header','uint32','string','float64','sensor_msgs/PointCloud2','geometry_msgs/PointStamped','geometry_msgs/PointStamped','geometry_msgs/PointStamped','geometry_msgs/PointStamped','float64','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3[]','std_msgs/Float32MultiArray','jsk_recognition_msgs/BoundingBox','geometry_msgs/PolygonStamped']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,id,label,score,cloud,min_point,max_point,avg_point,centroid_point,estimated_angle,dimensions,eigen_values,eigen_vectors,fpfh_descriptor,bounding_box,convex_hull
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_d3I.pack(_x.score, _x.cloud.header.seq, _x.cloud.header.stamp.secs, _x.cloud.header.stamp.nsecs))
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.cloud.is_dense, _x.min_point.header.seq, _x.min_point.header.stamp.secs, _x.min_point.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3I.pack(_x.min_point.point.x, _x.min_point.point.y, _x.min_point.point.z, _x.max_point.header.seq, _x.max_point.header.stamp.secs, _x.max_point.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3I.pack(_x.max_point.point.x, _x.max_point.point.y, _x.max_point.point.z, _x.avg_point.header.seq, _x.avg_point.header.stamp.secs, _x.avg_point.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3d3I.pack(_x.avg_point.point.x, _x.avg_point.point.y, _x.avg_point.point.z, _x.centroid_point.header.seq, _x.centroid_point.header.stamp.secs, _x.centroid_point.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_10d.pack(_x.centroid_point.point.x, _x.centroid_point.point.y, _x.centroid_point.point.z, _x.estimated_angle, _x.dimensions.x, _x.dimensions.y, _x.dimensions.z, _x.eigen_values.x, _x.eigen_values.y, _x.eigen_values.z))
      ...
      buff.write(_struct_I.pack(self.fpfh_descriptor.layout.data_offset))
      length = len(self.fpfh_descriptor.data)
      buff.write(_struct_I.pack(length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.fpfh_descriptor.data))
      _x = self
      buff.write(_struct_3I.pack(_x.bounding_box.header.seq, _x.bounding_box.header.stamp.secs, _x.bounding_box.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_10df4I.pack(_x.bounding_box.pose.position.x, _x.bounding_box.pose.position.y, _x.bounding_box.pose.position.z, _x.bounding_box.pose.orientation.x, _x.bounding_box.pose.orientation.y, _x.bounding_box.pose.orientation.z, _x.bounding_box.pose.orientation.w, _x.bounding_box.dimensions.x, _x.bounding_box.dimensions.y, _x.bounding_box.dimensions.z, _x.bounding_box.value, _x.bounding_box.label, _x.convex_hull.header.seq, _x.convex_hull.header.stamp.secs, _x.convex_hull.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.score, _x.cloud.header.seq, _x.cloud.header.stamp.secs, _x.cloud.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.cloud.is_dense, _x.min_point.header.seq, _x.min_point.header.stamp.secs, _x.min_point.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      ...
      (_x.min_point.point.x, _x.min_point.point.y, _x.min_point.point.z, _x.max_point.header.seq, _x.max_point.header.stamp.secs, _x.max_point.header.stamp.nsecs,) = _struct_3d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.max_point.point.x, _x.max_point.point.y, _x.max_point.point.z, _x.avg_point.header.seq, _x.avg_point.header.stamp.secs, _x.avg_point.header.stamp.nsecs,) = _struct_3d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.avg_point.point.x, _x.avg_point.point.y, _x.avg_point.point.z, _x.centroid_point.header.seq, _x.centroid_point.header.stamp.secs, _x.centroid_point.header.stamp.nsecs,) = _struct_3d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.centroid_point.point.x, _x.centroid_point.point.y, _x.centroid_point.point.z, _x.estimated_angle, _x.dimensions.x, _x.dimensions.y, _x.dimensions.z, _x.eigen_values.x, _x.eigen_values.y, _x.eigen_values.z,) = _struct_10d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.eigen_vectors = []
      ...
      (self.fpfh_descriptor.layout.data_offset,) = _struct_I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sf'%length
      ...
      (_x.bounding_box.header.seq, _x.bounding_box.header.stamp.secs, _x.bounding_box.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.bounding_box.pose.position.x, _x.bounding_box.pose.position.y, _x.bounding_box.pose.position.z, _x.bounding_box.pose.orientation.x, _x.bounding_box.pose.orientation.y, _x.bounding_box.pose.orientation.z, _x.bounding_box.pose.orientation.w, _x.bounding_box.dimensions.x, _x.bounding_box.dimensions.y, _x.bounding_box.dimensions.z, _x.bounding_box.value, _x.bounding_box.label, _x.convex_hull.header.seq, _x.convex_hull.header.stamp.secs, _x.convex_hull.header.stamp.nsecs,) = _struct_10df4I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
