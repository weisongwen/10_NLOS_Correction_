...
"""autogenerated by genpy from lidar_tracker/DetectedObjectArray.msg. Do not edit."""
import sys
...
class DetectedObjectArray(genpy.Message):
  _md5sum = "97ce09d3045ede2dcb694cef3e3d2f9f"
  _type = "lidar_tracker/DetectedObjectArray"
...
"""
  ...
  _slot_types = ['std_msgs/Header','lidar_tracker/DetectedObject[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = lidar_tracker.msg.DetectedObject()
        _v11 = val1.header
        start = end
        end += 4
