...
"""autogenerated by genpy from lidar_tracker/CloudClusterArray.msg. Do not edit."""
import sys
...
class CloudClusterArray(genpy.Message):
  _md5sum = "e8f793f47ee2bf0298da4f506e07b572"
  _type = "lidar_tracker/CloudClusterArray"
...
float32 z"""
  ...
  _slot_types = ['std_msgs/Header','lidar_tracker/CloudCluster[]']
    ...
    try:
      ...
      for val1 in self.clusters:
        ...
        if python3:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_d.pack(val1.score))
        _v3 = val1.cloud
        _v4 = _v3.header
        ...
        if type(_x) in [list, tuple]:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_B.pack(_v3.is_dense))
        _v6 = val1.min_point
        _v7 = _v6.header
        ...
        _x = _v21
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        buff.write(_struct_d.pack(val1.estimated_angle))
        ...
        buff.write(_struct_I.pack(_v25.data_offset))
        ...
        buff.write(_struct_3d.pack(_x.x, _x.y, _x.z))
        _x = _v26
        buff.write(_struct_fI.pack(_x.value, _x.label))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = lidar_tracker.msg.CloudCluster()
        _v37 = val1.header
        start = end
        end += 4
        ...
        (val1.score,) = _struct_d.unpack(str[start:end])
        _v39 = val1.cloud
        _v40 = _v39.header
        start = end
        end += 4
        ...
        (_v39.is_dense,) = _struct_B.unpack(str[start:end])
        ...
        (val1.estimated_angle,) = _struct_d.unpack(str[start:end])
        ...
        (_v61.data_offset,) = _struct_I.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sf'%length
        ...
        (_x.value, _x.label,) = _struct_fI.unpack(str[start:end])
    ...
    try:
      ...
      for val1 in self.clusters:
        ...
        if type(_x) in [list, tuple]:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_struct_B.pack(_v75.is_dense))
        _v78 = val1.min_point
        _v79 = _v78.header
        ...
        for val4 in _v97.dim:
          ...
          _x = val4
          buff.write(_struct_2I.pack(_x.size, _x.stride))
        buff.write(_struct_I.pack(_v97.data_offset))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_v111.is_dense,) = _struct_B.unpack(str[start:end])
        ...
        (_v133.data_offset,) = _struct_I.unpack(str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sf'%length
