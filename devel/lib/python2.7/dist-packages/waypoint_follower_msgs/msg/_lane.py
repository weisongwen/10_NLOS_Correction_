...
"""autogenerated by genpy from waypoint_follower_msgs/lane.msg. Do not edit."""
import sys
...
class lane(genpy.Message):
  _md5sum = "c019424de6b97427bc92ca65e30f8a13"
  _type = "waypoint_follower_msgs/lane"
...
float64 rw
"""
  __slots__ = ['header','increment','waypoints']
  _slot_types = ['std_msgs/Header','int32','waypoint_follower_msgs/waypoint[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_struct_i.pack(self.increment))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.increment,) = _struct_i.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.waypoints = []
