  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.data:
        _x = val1
        buff.write(_struct_i5d4i.pack(_x.pid, _x.b, _x.l, _x.h, _x.bx, _x.ly, _x.ref, _x.mcode1, _x.mcode2, _x.mcode3))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.pid, _x.b, _x.l, _x.h, _x.bx, _x.ly, _x.ref, _x.mcode1, _x.mcode2, _x.mcode3,) = _struct_i5d4i.unpack(str[start:end])
