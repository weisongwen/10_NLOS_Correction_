...
struct Signal_
{
  ...
  _linkid_type linkid;
    ...
    enum { RED = 1u };
     enum { BLUE = 2u };
     enum { YELLOW = 3u };
     enum { PEDESTRIAN_RED = 4u };
     enum { PEDESTRIAN_BLUE = 5u };
     enum { OTHER = 9u };
...
struct MD5Sum< ::vector_map_msgs::Signal_<ContainerAllocator> >
{
  ...
  {
    return "ec4535ac526f5f54617e726aff45e964";
  }

  static const char* value(const ::vector_map_msgs::Signal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xec4535ac526f5f54ULL;
  static const uint64_t static_value2 = 0x617e726aff45e964ULL;
};
