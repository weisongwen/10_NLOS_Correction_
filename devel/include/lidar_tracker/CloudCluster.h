// Generated by gencpp from file lidar_tracker/CloudCluster.msg
// DO NOT EDIT!


#ifndef LIDAR_TRACKER_MESSAGE_CLOUDCLUSTER_H
#define LIDAR_TRACKER_MESSAGE_CLOUDCLUSTER_H
...
struct CloudCluster_
{
  ...
  typedef boost::shared_ptr< ::lidar_tracker::CloudCluster_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::lidar_tracker::CloudCluster_<ContainerAllocator> const> ConstPtr;

}; // struct CloudCluster_

typedef ::lidar_tracker::CloudCluster_<std::allocator<void> > CloudCluster;

typedef boost::shared_ptr< ::lidar_tracker::CloudCluster > CloudClusterPtr;
typedef boost::shared_ptr< ::lidar_tracker::CloudCluster const> CloudClusterConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::lidar_tracker::CloudCluster_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::lidar_tracker::CloudCluster_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::lidar_tracker::CloudCluster_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::lidar_tracker::CloudCluster_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::lidar_tracker::CloudCluster_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::lidar_tracker::CloudCluster_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lidar_tracker::CloudCluster_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::lidar_tracker::CloudCluster_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::lidar_tracker::CloudCluster_<ContainerAllocator> >
{
  ...
  static const char* value(const ::lidar_tracker::CloudCluster_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xd79f3de19e797fd2ULL;
  static const uint64_t static_value2 = 0x9b6fdf347509c864ULL;
};

template<class ContainerAllocator>
struct DataType< ::lidar_tracker::CloudCluster_<ContainerAllocator> >
{
  static const char* value()
  {
    return "lidar_tracker/CloudCluster";
  }
...
template<class ContainerAllocator>
struct Definition< ::lidar_tracker::CloudCluster_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::lidar_tracker::CloudCluster_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::lidar_tracker::CloudCluster_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::lidar_tracker::CloudCluster_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // LIDAR_TRACKER_MESSAGE_CLOUDCLUSTER_H
