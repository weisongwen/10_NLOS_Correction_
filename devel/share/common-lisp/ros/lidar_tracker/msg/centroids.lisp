...
(cl:defmethod cl:initialize-instance :after ((m <centroids>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'centroids)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lidar_tracker-msg:<centroids> is deprecated: use lidar_tracker-msg:centroids instead.")))
...
(cl:defmethod points-val ((m <centroids>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader lidar_tracker-msg:points-val is deprecated.  Use lidar_tracker-msg:points instead.")
  (points m))
