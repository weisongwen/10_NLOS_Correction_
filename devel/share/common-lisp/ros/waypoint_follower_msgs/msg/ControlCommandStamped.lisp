...
(cl:defclass <ControlCommandStamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (cmd
    :reader cmd
    :initarg :cmd
    :type waypoint_follower_msgs-msg:ControlCommand
    :initform (cl:make-instance 'waypoint_follower_msgs-msg:ControlCommand)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ControlCommandStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ControlCommandStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name waypoint_follower_msgs-msg:<ControlCommandStamped> is deprecated: use waypoint_follower_msgs-msg:ControlCommandStamped instead.")))
...
(cl:defmethod cmd-val ((m <ControlCommandStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_follower_msgs-msg:cmd-val is deprecated.  Use waypoint_follower_msgs-msg:cmd instead.")
  (cmd m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ControlCommandStamped>)))
  ...
  "waypoint_follower_msgs/ControlCommandStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ControlCommandStamped)))
  "Returns string type for a message object of type 'ControlCommandStamped"
  "waypoint_follower_msgs/ControlCommandStamped")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ControlCommandStamped>)))
  ...
  "73c97244027161f06ca21c6729b9fa2f")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ControlCommandStamped)))
  "Returns md5sum for a message object of type 'ControlCommandStamped"
  "73c97244027161f06ca21c6729b9fa2f")
