...
;//! \htmlinclude obj_pose.msg.html

(cl:defclass <obj_pose> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass obj_pose (<obj_pose>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <obj_pose>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'obj_pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv_tracker_msgs-msg:<obj_pose> is deprecated: use cv_tracker_msgs-msg:obj_pose instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <obj_pose>))
...
(cl:defmethod type-val ((m <obj_pose>))
...
(cl:defmethod obj_id-val ((m <obj_pose>))
...
(cl:defmethod obj-val ((m <obj_pose>))
  ...
  (obj m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <obj_pose>) ostream)
  "Serializes a message object of type '<obj_pose>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <obj_pose>) istream)
  "Deserializes a message object of type '<obj_pose>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<obj_pose>)))
  "Returns string type for a message object of type '<obj_pose>"
  "cv_tracker_msgs/obj_pose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'obj_pose)))
  "Returns string type for a message object of type 'obj_pose"
  "cv_tracker_msgs/obj_pose")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<obj_pose>)))
  "Returns md5sum for a message object of type '<obj_pose>"
  "54a63c36291a0587bc8b4eba25a10459")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'obj_pose)))
  "Returns md5sum for a message object of type 'obj_pose"
  "54a63c36291a0587bc8b4eba25a10459")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<obj_pose>)))
  "Returns full string definition for message of type '<obj_pose>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'obj_pose)))
  "Returns full string definition for message of type 'obj_pose"
  (cl:format cl:nil "Header header~%string type~%int32[] obj_id~%geometry_msgs/PoseArray[] obj~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/PoseArray~%# An array of poses with a header for global reference.~%~%Header header~%~%Pose[] poses~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of position and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <obj_pose>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <obj_pose>))
