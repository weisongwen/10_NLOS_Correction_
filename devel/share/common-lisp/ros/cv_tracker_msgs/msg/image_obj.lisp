...
(cl:defclass <image_obj> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (obj
    :reader obj
    :initarg :obj
    :type (cl:vector cv_tracker_msgs-msg:image_rect)
   :initform (cl:make-array 0 :element-type 'cv_tracker_msgs-msg:image_rect :initial-element (cl:make-instance 'cv_tracker_msgs-msg:image_rect))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <image_obj>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'image_obj)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv_tracker_msgs-msg:<image_obj> is deprecated: use cv_tracker_msgs-msg:image_obj instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <image_obj>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'obj)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cv_tracker_msgs-msg:image_rect))
