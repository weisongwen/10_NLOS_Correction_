...
(cl:defclass <image_obj_tracked> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass image_obj_tracked (<image_obj_tracked>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <image_obj_tracked>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'image_obj_tracked)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cv_tracker_msgs-msg:<image_obj_tracked> is deprecated: use cv_tracker_msgs-msg:image_obj_tracked instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <image_obj_tracked>))
...
(cl:defmethod type-val ((m <image_obj_tracked>))
...
(cl:defmethod total_num-val ((m <image_obj_tracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker_msgs-msg:total_num-val is deprecated.  Use cv_tracker_msgs-msg:total_num instead.")
  (total_num m))

(cl:ensure-generic-function 'obj_id-val :lambda-list '(m))
(cl:defmethod obj_id-val ((m <image_obj_tracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker_msgs-msg:obj_id-val is deprecated.  Use cv_tracker_msgs-msg:obj_id instead.")
  (obj_id m))

(cl:ensure-generic-function 'rect_ranged-val :lambda-list '(m))
(cl:defmethod rect_ranged-val ((m <image_obj_tracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker_msgs-msg:rect_ranged-val is deprecated.  Use cv_tracker_msgs-msg:rect_ranged instead.")
  (rect_ranged m))

(cl:ensure-generic-function 'real_data-val :lambda-list '(m))
(cl:defmethod real_data-val ((m <image_obj_tracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker_msgs-msg:real_data-val is deprecated.  Use cv_tracker_msgs-msg:real_data instead.")
  (real_data m))

(cl:ensure-generic-function 'lifespan-val :lambda-list '(m))
(cl:defmethod lifespan-val ((m <image_obj_tracked>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cv_tracker_msgs-msg:lifespan-val is deprecated.  Use cv_tracker_msgs-msg:lifespan instead.")
  (lifespan m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <image_obj_tracked>) ostream)
  "Serializes a message object of type '<image_obj_tracked>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <image_obj_tracked>) istream)
  "Deserializes a message object of type '<image_obj_tracked>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<image_obj_tracked>)))
  "Returns string type for a message object of type '<image_obj_tracked>"
  "cv_tracker_msgs/image_obj_tracked")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'image_obj_tracked)))
  "Returns string type for a message object of type 'image_obj_tracked"
  "cv_tracker_msgs/image_obj_tracked")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<image_obj_tracked>)))
  "Returns md5sum for a message object of type '<image_obj_tracked>"
  "6f3751f77b67bc47fba29cbdd3ea3d56")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'image_obj_tracked)))
  "Returns md5sum for a message object of type 'image_obj_tracked"
  "6f3751f77b67bc47fba29cbdd3ea3d56")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<image_obj_tracked>)))
  "Returns full string definition for message of type '<image_obj_tracked>"
  (cl:format cl:nil "Header header~%string type~%uint8 total_num~%int32[] obj_id~%image_rect_ranged[] rect_ranged~%int32[] real_data~%int32[] lifespan~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: cv_tracker_msgs/image_rect_ranged~%image_rect rect~%float32 range~%float32 min_height~%float32 max_height~%~%================================================================================~%MSG: cv_tracker_msgs/image_rect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'image_obj_tracked)))
  "Returns full string definition for message of type 'image_obj_tracked"
  (cl:format cl:nil "Header header~%string type~%uint8 total_num~%int32[] obj_id~%image_rect_ranged[] rect_ranged~%int32[] real_data~%int32[] lifespan~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: cv_tracker_msgs/image_rect_ranged~%image_rect rect~%float32 range~%float32 min_height~%float32 max_height~%~%================================================================================~%MSG: cv_tracker_msgs/image_rect~%int32 x~%int32 y~%int32 height~%int32 width~%float32 score~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <image_obj_tracked>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <image_obj_tracked>))
  "Converts a ROS message object to a list"
  (cl:list 'image_obj_tracked
