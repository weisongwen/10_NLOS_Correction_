...
if("TRUE" STREQUAL "TRUE")
  set(vector_map_server_SOURCE_PREFIX /home/wenws/10_NLOS_Correction_/src/vector_map_server)
  set(vector_map_server_DEVEL_PREFIX /home/wenws/10_NLOS_Correction_/devel)
  ...
  set(vector_map_server_INSTALL_PREFIX /home/wenws/10_NLOS_Correction_/install)
...
if(NOT "/home/wenws/10_NLOS_Correction_/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vector_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wenws/10_NLOS_Correction_/src/vector_map_server/${idir}'.  Ask the maintainer 'syouji <syouji@axe.bz>' to fix it.")
    endif()
...
set(depends "message_runtime;roscpp;geometry_msgs;waypoint_follower_msgs;visualization_msgs;vector_map_msgs;vector_map")
