...
if("TRUE" STREQUAL "TRUE")
  set(tf2_tools_SOURCE_PREFIX /home/wenws/10_NLOS_Correction_/src/geometry2/tf2_tools)
  set(tf2_tools_DEVEL_PREFIX /home/wenws/10_NLOS_Correction_/devel)
  ...
  set(tf2_tools_INSTALL_PREFIX /home/wenws/10_NLOS_Correction_/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wenws/10_NLOS_Correction_/src/geometry2/tf2_tools/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${tf2_tools_dep}_FOUND)
      find_package(${tf2_tools_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tf2_tools_dep} REQUIRED ${depend_list})
  endif()
