...
if("TRUE" STREQUAL "TRUE")
  set(tf2_SOURCE_PREFIX /home/wenws/10_NLOS_Correction_/src/geometry2/tf2)
  set(tf2_DEVEL_PREFIX /home/wenws/10_NLOS_Correction_/devel)
  set(tf2_INSTALL_PREFIX "")
  set(tf2_PREFIX ${tf2_DEVEL_PREFIX})
else()
  set(tf2_SOURCE_PREFIX "")
  set(tf2_DEVEL_PREFIX "")
  set(tf2_INSTALL_PREFIX /home/wenws/10_NLOS_Correction_/install)
...
if(NOT "/home/wenws/10_NLOS_Correction_/src/geometry2/tf2/include;/usr/include " STREQUAL " ")
  set(tf2_INCLUDE_DIRS "")
  set(_include_dirs "/home/wenws/10_NLOS_Correction_/src/geometry2/tf2/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tf2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wenws/10_NLOS_Correction_/src/geometry2/tf2/${idir}'.  Ask the maintainer 'Tully Foote <tfoote@osrfoundation.org>' to fix it.")
    endif()
